...
public class EmployeeServiceTest {
	...
	public void findAllEmployee_Test() {
		shekhar.setEmployeeId(101);
		swapnil.setEmployeeId(501);
		List<Employee> empList = List.of(shekhar, swapnil);
	...
	public void updateEmployee() {
		shekhar.setEmployeeId(101);
		when(employeeRepository.findById(any(Integer.class))).thenReturn(Optional.of(shekhar));
	...
	public void findEmployeeById_Test() {
		shekhar.setEmployeeId(101);
	...
	@Test
	@DisplayName("Find Employee By Id Test")
	public void findEmployeeByIdException_Test() {
		shekhar.setEmployeeId(101);
	...
	public void deleteEmployeeById_Test() {
		...
		verify(employeeRepository, times(1)).delete(shekhar);
	}
